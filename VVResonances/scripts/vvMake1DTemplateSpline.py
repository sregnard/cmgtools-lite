...
histoCoarse_gpt_up=data.drawTH1(options.var,options.cut+'*'+uncw1,"1",newNbins+2,options.minx-newBinWidth,options.maxx+newBinWidth)
expandHisto(histoCoarse_gpt_up,histogram_gpt_up)
histoCoarse_gpt_down=data.drawTH1(options.var,options.cut+'*(1/'+uncw1+')',"1",newNbins+2,options.minx-newBinWidth,options.maxx+newBinWidth)
expandHisto(histoCoarse_gpt_down,histogram_gpt_down)
histoCoarse_gpt2_up=data.drawTH1(options.var,options.cut+'*'+uncw2,"1",newNbins+2,options.minx-newBinWidth,options.maxx+newBinWidth)
expandHisto(histoCoarse_gpt2_up,histogram_gpt2_up)
histoCoarse_gpt2_down=data.drawTH1(options.var,options.cut+'*(1/'+uncw2+')',"1",newNbins+2,options.minx-newBinWidth,options.maxx+newBinWidth)
expandHisto(histoCoarse_gpt2_down,histogram_gpt2_down)
histoCoarse_sd_up=data.drawTH1(varup,options.cut,"1",newNbins+2,options.minx-newBinWidth,options.maxx+newBinWidth)
expandHisto(histoCoarse_sd_up,histogram_sd_up)
histoCoarse_sd_down=data.drawTH1(vardown,options.cut,"1",newNbins+2,options.minx-newBinWidth,options.maxx+newBinWidth)
