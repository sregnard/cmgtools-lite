...
table_Gbulk = [ ## from https://github.com/CrossSectionsLHC/WED/blob/master/KKGraviton_Bulk/GF_NLO_13TeV_ktilda_0p1.txt and https://github.com/CrossSectionsLHC/WED/blob/master/KKGraviton_Bulk/Decay_long.txt
...
table_HVT_modelB = [ ## from https://github.com/jngadiub/Cross_Sections_HVT/blob/master/13TeV.txt
...
table_HVT_modelC = [ ## from https://github.com/zucchett/HVT/blob/master/dataframe.csv
...
plots['VBFZprToWW']  = { 
    'lgdL':0.37, 'lgdR':0.92, 'lgdD':0.64, 'lgdU':0.88, 
    'blind':0, 'grid':0,
    'titleX':"m_{Z'} (GeV)",
