...
class CMSPlotLabel:
    def __init__(self,text='CMS',extraText='Preliminary',lumiPeriods={'2015':{'lumi':'2.6 fb^{-1} ','energy':'13 TeV'},'2016':{'lumi':'35.9 fb^{-1} ','energy':'13 TeV'},'2017':{'lumi':'41.5 fb^{-1} ','energy':'13 TeV'},'2018':{'lumi':'59.7 fb^{-1} ','energy':'13 TeV'},'Run2':{'lumi':'137 fb^{-1} ','energy':'13 TeV'}}):
        self.cmsText=text
        self.cmsTextFont=61
