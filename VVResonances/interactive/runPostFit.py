...
#for c in ['Wplus','Wminus']:
    ...
    for p in pur:
        for l in ['e','mu']:
            ...
            plotter.drawBinned("MLNuJ","m_{WV} (GeV)",label,c+"_"+l+"_"+p+"_13TeV",[0,0],options.doUncBand,1,"")
            ...
            plotter.drawBinned("MLNuJ","m_{WV} (GeV)",label,c+"_"+l+"_"+p+"_13TeV",[0,0],options.doUncBand,0,"MJ:sig:66:86")
            cmsLabel(plotter.canvas)
            saveCanvas(plotter.canvas,directory+"/postFitMVVW_"+s+"_"+c+"_"+l+"_"+p+"_13TeV")
            ...
            saveCanvas(plotter.canvas,directory+"/postFitMVVWZoom_"+s+"_"+c+"_"+l+"_"+p+"_13TeV")
...
#            saveCanvas(plotter.canvas,directory+"/postFit_"+s+"_"+c+"_"+l+"_"+p+"_13TeV")
            ...
            plotter.drawBinned("MLNuJ","m_{WV} (GeV)",label,c+"_"+l+"_"+p+"_13TeV",[0,0],options.doUncBand,c!='vbf',"MJ:low:30:64")
            cmsLabel(plotter.canvas)
            saveCanvas(plotter.canvas,directory+"/postFitMVVLo_"+s+"_"+c+"_"+l+"_"+p+"_13TeV")

            plotter.drawBinned("MLNuJ","m_{WV} (GeV)",label,c+"_"+l+"_"+p+"_13TeV",[0,0],options.doUncBand,c!='vbf',"MJ:high:106:210")
            cmsLabel(plotter.canvas)
            saveCanvas(plotter.canvas,directory+"/postFitMVVHi_"+s+"_"+c+"_"+l+"_"+p+"_13TeV")
