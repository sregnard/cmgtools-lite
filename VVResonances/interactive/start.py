...
def makeEff():
    ...
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[55,60,120,200,300,500,1000],[0.,0.9,1.2,2.1,2.4],"*".join([cuts['common'],cuts['mu'],metPaths]),muPaths)
    g[0].Write("MU_MC")
    g[1].Write("MU_MC_pass")
    g[2].Write("MU_MC_total")
    g=efficiency2D(DATA, "abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[55,60,120,200,300,500,1000],[0.,0.9,1.2,2.1,2.4],"*".join([cuts['common'],cuts['mu'],metPaths]),muPaths)
    g[0].Write("MU_DATA")
    ...
    g[0].Write("checkcorr_ELEandMETELE_MC")
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[55,60,120,200,300,500,1000],[0.,0.9,1.2,2.1,2.4],"*".join([cuts['common'],cuts['mu']]),muPaths)
    g[0].Write("checkcorr_MU_MC")
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[55,60,120,200,300,500,1000],[0.,0.9,1.2,2.1,2.4],"*".join([cuts['common'],cuts['mu']]),metPaths)
    g[0].Write("checkcorr_METMU_MC")
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[55,60,120,200,300,500,1000],[0.,0.9,1.2,2.1,2.4],"*".join([cuts['common'],cuts['mu']]),"*".join([muPaths,metPaths]))
    g[0].Write("checkcorr_MUandMETMU_MC")
