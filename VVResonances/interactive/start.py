...
def makeEff():
    ...
    g[0].Write("MET_ELE_MC_eff")
    g[1].Write("MET_ELE_MC_pass")
    g[2].Write("MET_ELE_MC_total")
    g=efficiency1D(DATA, "lnujj_l1_met_pt",[50,80,100,150,200,250,300,500,1000],"*".join([cuts['common'],cuts['e'],elePaths]),metPaths)
    g[0].Write("MET_ELE_DATA_eff")
    g[1].Write("MET_ELE_DATA_pass")
    g[2].Write("MET_ELE_DATA_total")
    g=efficiency1D(VJets,"lnujj_l1_met_pt",[50,80,100,150,200,250,300,500,1000],"*".join([cuts['common'],cuts['mu'],muPaths]),metPaths)
    g[0].Write("MET_MU_MC_eff")
    g[1].Write("MET_MU_MC_pass")
    g[2].Write("MET_MU_MC_total")
    g=efficiency1D(DATA, "lnujj_l1_met_pt",[50,80,100,150,200,250,300,500,1000],"*".join([cuts['common'],cuts['mu'],muPaths]),metPaths)
    g[0].Write("MET_MU_DATA_eff")
    g[1].Write("MET_MU_DATA_pass")
    g[2].Write("MET_MU_DATA_total")

    g=efficiency2D(VJets,"lnujj_l1_l_eta:lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[-2.5,-1.7,-0.9,0.9,1.7,2.5],"*".join([cuts['common'],cuts['e'],metPaths]),elePaths)
    g[0].Write("ELE_MC_eff")
    g[1].Write("ELE_MC_pass")
    g[2].Write("ELE_MC_total")
    g=efficiency2D(DATA, "lnujj_l1_l_eta:lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[-2.5,-1.7,-0.9,0.9,1.7,2.5],"*".join([cuts['common'],cuts['e'],metPaths]),elePaths)
    g[0].Write("ELE_DATA_eff")
    g[1].Write("ELE_DATA_pass")
    g[2].Write("ELE_DATA_total")

    g=efficiency2D(VJets,"lnujj_l1_l_eta:lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[-2.5,-1.7,-0.9,0.9,1.7,2.5],"*".join([cuts['common'],cuts['mu'],metPaths]),muPaths)
    g[0].Write("MU_MC_eff")
    g[1].Write("MU_MC_pass")
    g[2].Write("MU_MC_total")
    g=efficiency2D(DATA, "lnujj_l1_l_eta:lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[-2.5,-1.7,-0.9,0.9,1.7,2.5],"*".join([cuts['common'],cuts['mu'],metPaths]),muPaths)
    g[0].Write("MU_DATA_eff")
    g[1].Write("MU_DATA_pass")
    g[2].Write("MU_DATA_total")
    
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['e'],metPaths]),elePaths)
    g[0].Write("ELE_MC_abseta_eff")
    g[1].Write("ELE_MC_abseta_pass")
    g[2].Write("ELE_MC_abseta_total")
    g=efficiency2D(DATA, "abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['e'],metPaths]),elePaths)
    g[0].Write("ELE_DATA_abseta_eff")
    g[1].Write("ELE_DATA_abseta_pass")
    g[2].Write("ELE_DATA_abseta_total")

    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['mu'],metPaths]),muPaths)
    g[0].Write("MU_MC_abseta_eff")
    g[1].Write("MU_MC_abseta_pass")
    g[2].Write("MU_MC_abseta_total")
    g=efficiency2D(DATA, "abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['mu'],metPaths]),muPaths)
    g[0].Write("MU_DATA_abseta_eff")
    g[1].Write("MU_DATA_abseta_pass")
    g[2].Write("MU_DATA_abseta_total")

    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['e']]),elePaths)
    g[0].Write("checkcorr_ELE_MC_abseta_eff")
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['e']]),metPaths)
    g[0].Write("checkcorr_METELE_MC_abseta_eff")
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['e']]),"*".join([elePaths,metPaths]))
    g[0].Write("checkcorr_ELEandMETELE_MC_abseta_eff")
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['mu']]),muPaths)
    g[0].Write("checkcorr_MU_MC_abseta_eff")
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['mu']]),metPaths)
    g[0].Write("checkcorr_METMU_MC_abseta_eff")
    g=efficiency2D(VJets,"abs(lnujj_l1_l_eta):lnujj_l1_l_pt",[50,70,80,100,120,150,200,250,300,500,1000],[0.,0.9,1.7,2.5],"*".join([cuts['common'],cuts['mu']]),"*".join([muPaths,metPaths]))
    g[0].Write("checkcorr_MUandMETMU_MC_abseta_eff")
